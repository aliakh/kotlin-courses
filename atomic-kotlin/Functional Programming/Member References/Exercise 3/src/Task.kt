...
private fun getNonTrivialDivisors(num: Int): List<Int> =
  (2 until num).filter { num % it == 0 }

fun Int.isPrime(): Boolean =
  this != 1 && getNonTrivialDivisors(this).isEmpty()

fun isPerfect(num: Int): Boolean =
  num != 1 && 1 + getNonTrivialDivisors(num).sum() == num
...
fun main() {
  ...
  prime.takeLast(7) eq listOf(953, 967, 971, 977, 983, 991, 997)
